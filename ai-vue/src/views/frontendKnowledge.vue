        ...
        <div class="content">
            ...
            <div class="article-list">
                <div v-for="item in articleList" :key="item.id" class="article-item" @click="goToArticle(item.id)">
                    <el-image :src="getImageUrl(item.coverImage)" style="width: 240px; height: 150px;"></el-image>
                    <div class="info">
                        <div class="title">
                            <h3>{{ item.title }}</h3>
...
const getImageUrl = (url) => {
    return url ? 'http://159.75.169.224:1235' + url : 'https://file.itndedu.com/psychology_ai_png'
}

    ...
    <div>
       ...
       <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column label="操作" width="240px" fixed="right">
                <template #default="scope">
                    <el-button text @click="viewSessionDetail(scope.row)" type="primary" size="mini">详情</el-button>
            ...
            <div class="detail-section">
                ...
                <el-descriptions :column="2" border>
                    ...
                    <el-descriptions-item label="主要情绪">
                        <el-tag type="info" :type="getEmotionTagType(currentDetail.dominantEmotion)">{{ currentDetail.dominantEmotion || '-' }}</el-tag>
                    </el-descriptions-item>
...
const formItem = [
    ...
    { comp: 'select', prop: 'moodScreRange', label: '情绪评分', placeholder: '请选择评分范围', options: [{ 
        label: '低分', value: '低分(1-3)' 
    }, { 
        label: '中分', value: '中分(4-6)' 
    }, {
        label: '高分', value: '高分(7-10)'
    }] }
]

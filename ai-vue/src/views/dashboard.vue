                ...
                <el-card>
                    <div v-if="aiData.systemOverview" class="card-content">
                        ...
                        <div class="info">
                            ...
                            <p class="value">{{ aiData.consultationStats?.totalSessions || 0 }}</p>
            ...
            <el-col :span="12">
                <el-card style="width: 100%">
                    ...
                    <div class="chart-content">
                        <div ref="emtionChartRef" style="width: 100%; height: 300px;"></div>
                    </div>
                </el-card>
            </el-col>
            <el-col :span="12">
...
//情绪趋势
// emtionChart 图表实例 emtionChartRef 图表引用(容器)
let emtionChart = null
const emtionChartRef = ref(null)
const initEmtionChart = () => {
    if (!emtionChartRef.value) {
        return
    }
    // 初始化图表
    if (emtionChart) {
    ...
    // 创建echarts实例
    emtionChart = echarts.init(emtionChartRef.value)
    // 获取情绪趋势的数据
    ...
    // 调用echarts实例的setOption方法设置配置项
    emtionChart.setOption(option)
}
// 会话统计
